...
public class AliPayUtil {
    ...
    /**
     * 阿里支付，首先对支付进行配置
     * @return  支付页面的html形式，里面包含订单信息等。
     */
    @RequestMapping("/alipayTest")
    public String aliPay() {
        AliPayConfigStorage aliPayConfigStorage = new AliPayConfigStorage();

        aliPayConfigStorage.setPid("2088102175307622");  //商户id
        aliPayConfigStorage.setAppId("2016091200494690"); //应用id
        ...
        aliPayConfigStorage.setNotifyUrl("http://k19847n443.51mypc.cn:37169/notifyalipay"); //回调地址，已经在ali开放平台设置
//        aliPayConfigStorage.setReturnUrl("http://k19847n443.51mypc.cn:37169/notify/a.html");
        aliPayConfigStorage.setSignType("RSA2");  //签名类型
        aliPayConfigStorage.setSeller("2088102175307622"); //商户id
        aliPayConfigStorage.setInputCharset("utf-8");    //编码
        //是否为测试账号，沙箱环境
        aliPayConfigStorage.setTest(true);  //是否为测试，将会选择url进行跳转
        //支付服务
